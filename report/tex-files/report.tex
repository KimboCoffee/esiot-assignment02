...
\begin{document}
	...
	For what concerns implementing choices, a simple class used as a message handler was realized to communicate with the Arduino UNO Board. Then, a main component is used to develop the GUI and exploits the message handler to cooperate with the external embedded system.
